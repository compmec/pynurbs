...
class TestSplineCurve:
    ...
    def create_random_controlpoints(self, npts: int, ndim: int = 0):
        if ndim == 0:
            return np.random.uniform(-1, 1, npts)
        return np.random.uniform(-1, 1, (npts, ndim))
    ...
    def test_creationfail(self, ntests=100):
        for i in range(ntests):
            degree = np.random.randint(0, 5)
            npts = np.random.randint(degree + 1, degree + 11)
            ndim = np.random.randint(1, 4)
    ...
    def test_shapetype_callscalar_scalarpoints(self, ntests=10):
        degree = np.random.randint(0, 5)
        npts = np.random.randint(degree + 1, degree + 11)
        U = self.create_random_knotvector(degree, npts)
        P = self.create_random_controlpoints(npts)
    ...
    def test_shapetype_callscalar_vectorialpoints(self, ntests=10):
        for i in range(ntests):
            degree = np.random.randint(0, 5)
            npts = np.random.randint(degree + 1, degree + 11)
            ndim = np.random.randint(1, 4)
    ...
    def test_shapetype_callvectorial_scalarpoints(self, ntests=10):
        for i in range(ntests):
            degree = np.random.randint(0, 5)
            npts = np.random.randint(degree + 1, degree + 11)
            U = self.create_random_knotvector(degree, npts)
    ...
    def test_shapetype_callvectorial_vectorialpoints(self, ntests=10):
        for i in range(ntests):
            degree = np.random.randint(0, 5)
            npts = np.random.randint(degree + 1, degree + 11)
            ndim = np.random.randint(1, 4)
    ...
    def test_bezier_curve_values(self):
        for degree in range(1, 5):
            npts = degree + 1
            U = GeneratorKnotVector.bezier(p=degree)
            ndim = np.random.randint(0, 4)
            P = self.create_random_controlpoints(npts, ndim)
            C = SplineCurve(U, P)
            ...
            for i, ti in enumerate(t):
                ...
                for j, Pj in enumerate(P):
                    Cgood[i] += (
                        math.comb(npts - 1, j) * ti1 ** (npts - 1 - j) * ti**j * Pj
                    )
    ...
    def test_knot_insert_random(self, ntests=100):
        for i in range(ntests):
            degree = np.random.randint(1, 5)
            npts = np.random.randint(degree + 1, degree + 11)
            ndim = np.random.randint(0, 5)
    ...
    def test_knot_insert_remove_once_random(self, ntests=10):
    ...
    def test_degree_increase(self, ntests=100):
        for degree in range(1, 6):
            for i in range(ntests):
                npts = np.random.randint(degree + 1, degree + 11)
                ndim = np.random.randint(0, 5)
    ...
    def test_degree_decrease(self, ntests=100):
        pass
    ...
    def test_degree_increase_decrease(self, ntests=100):
        for degree in range(1, 6):
            for i in range(ntests):
                npts = np.random.randint(degree + 1, degree + 11)
                ndim = np.random.randint(0, 5)
